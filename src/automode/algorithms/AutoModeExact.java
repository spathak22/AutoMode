...
//		Set<String> headModeSet = new HashSet<>();
        ...
        DataModel dataModel = this.buildModes(examplesRelation, relations, Constants.Types.EXACT_IND.getValue(), threshold, thresholdType, target, dbUrl, storedProcedure);
